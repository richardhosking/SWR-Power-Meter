/*********************************************************************
adapted from Library for Monochrome OLEDs based on SSD1305 drivers
...
*/
Display::Display(uint16_t w, uint16_t h, TwoWire *twi,
...
/*!
    ...
    @note   Call the object's begin() function before use -- buffer
            allocation is performed there!
*/
Display::Display(uint16_t w, uint16_t h, int8_t mosi_pin,
...
/*!
    ...
    @note   Call the object's begin() function before use -- buffer
            allocation is performed there!
*/
Display::Display(uint16_t w, uint16_t h, SPIClass *spi,
...
*/
bool Display::begin(uint8_t addr, bool reset) {
...
/*!
   ...
   off all pixels
*/
void Display::sleep(void) { oled_command(SSD1305_DISPLAYOFF); }

/*!
    @brief  Wake the display driver from the low power mode
*/
void Display::wake(void) { oled_command(SSD1305_DISPLAYON); }


/*!
    @brief  Draw a rectangle
*/
void Display::drawRectangle(int16_t startx, int16_t starty, int16_t endx, int16_t endy, uint16_t color) {
